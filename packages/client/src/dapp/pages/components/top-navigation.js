...
export default class TopNavigation extends LitElement {
  ...
  getPages() {
    ...
    return staticPages.concat([{"name":"basic_nft","title":"Basic Non-fungible Token","description":"Create a simple non-fungible token for tracking unique assets associated with your dapp.","category":"Non-fungible Tokens","route":"/basic_nft"},{"name":"token","title":"Custom Token","description":"Create a token for tracking value associated with your dapp.","category":"Asset and Value Tracking","route":"/token"},{"name":"ipfs","title":"IPFS Documents","description":"InterPlanetary File System (decentralized file storage)","category":"File Storage","route":"/ipfs"}]); 
  }
